            ...
            onDetect: (barcodes) async {
              if (capture?.barcodes.first.rawValue !=
                ...
                String wifiResult() {
                  ...
                  if (scanResult.wifi!.encryptionType == EncryptionType.wpa ||
                      scanResult.wifi!.encryptionType == EncryptionType.wep) {
                          ...
                          onPressed: () {
                            if (_zoomFactor != 0.0 &&
                              ...
                              setState(() {
                                _zoomFactor = NP
                                    .minus(
                                      NP.round(_zoomFactor, 1).toDouble().abs(),
                                      0.1,
                                    )
                                    .toDouble();
                                cameraController.setZoomScale(_zoomFactor);
                                debugPrint('ZoomFactor = $_zoomFactor');
                              });
                            }
                          },
                          icon: const Icon(
